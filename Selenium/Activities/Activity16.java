...
public class Activity16 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("(//input[@placeholder='Username'])[2]")).sendKeys("Lavanya");
		driver.findElement(By.xpath("(//input[@placeholder='Password'])[2]")).sendKeys("Ibm1234");
		driver.findElement(By.xpath("(//input[@placeholder='Password'])[3]")).sendKeys("Ibm1234");
